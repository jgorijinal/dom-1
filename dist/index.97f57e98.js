...
})({"cuP10":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
window.dom = {
    ...
    style (node, name, value) {
        ...
        else if (typeof name === 'string') //dom.style(div,'border')
        return node.style[name];
        else if (name instanceof Object) {
            const object = name;
            for(let key in object)//dom.style(div,{border:'1px solid black',color:'blue'})
    ...
    each (nodeList, fn) {
        for(let i = 0; i < nodeList.length; i++)fn.call(undefined, nodeList[i]);
    },
    index (node) {
